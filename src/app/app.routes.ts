...
//         .then(m => (m as any).Surveys || (m as any).default)
//   },
  ...
  /** MAIN APP ROUTES */
  {
    ...
    loadComponent: () =>
      import('./layout/main-layout')
        .then(m => (m as any).MainLayout || (m as any).default),
    canActivate: [AuthGuard],
    children: [
      /** DASHBOARD */
      {
        path: 'dashboard',
        loadComponent: () =>
          import('./pages/dashboard-root/dashboard-root')
            .then(m => (m as any).Dashboard || (m as any).default)
      },
      ...
      /** EMPLOYEES */
      {
        path: 'employees',
        loadComponent: () =>
          import('./components/employee/employee-list')
            .then(m => (m as any).EmployeeList || (m as any).default)
      },
      {
        path: 'employees/add',
        loadComponent: () =>
          import('./components/employee/employee-form')
            .then(m => (m as any).EmployeeForm || (m as any).default)
      },
      {
        path: 'employees/edit/:id',
        loadComponent: () =>
